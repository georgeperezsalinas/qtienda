...
| QT-033 | P1 | Frontend | Version laptop/tablet del resto de la app (la tienda publica ya estaba): dashboard inicio, productos (grilla 2 col), finanzas (KPIs 4 col), configuracion, delivery, mis-pedidos y directorio de tiendas (grilla 2 col) dejan de verse como columna de celular centrada. | App completa aprovecha pantallas grandes. | Hecho 2026-07-10 (build verificado; falta deploy) |
