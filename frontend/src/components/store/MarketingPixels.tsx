...
// Inyecta los pixels de marketing del VENDEDOR (no de qtienda) en su tienda
// pública, si los configuró en Configuración → Marketing. Cada uno es
// completamente opcional e independiente — ninguno bloquea a los otros ni
// a la carga de la tienda.
...
export default function MarketingPixels({ tiktokPixelId, metaPixelId, googleAnalyticsId }: Props) {
  return (
    <>
      {tiktokPixelId && (
